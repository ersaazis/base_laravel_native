<x-layouts.app :title="$siteConfig['site_name']" :site-config="$siteConfig">
    <div class="flex min-h-[calc(100vh-7rem)] flex-col items-center justify-center gap-8 text-center" data-startup-screen data-mobile-animate>
        ...
        <div class="grid justify-items-center gap-4">
            ...
            <form method="POST" action="{{ route('startup.check') }}" data-startup-check>
                @csrf
            </form>
        </div>
    </div>
