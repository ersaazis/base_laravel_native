...
<svg class="{{ $class }}" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="{{ $stroke }}" stroke-linejoin="{{ $stroke }}">
    @switch($name)
        ...
        @case('fingerprint')
            <path d="M12 11.2a2.8 2.8 0 0 0-2.8 2.8c0 1.8 1.3 3.2 2.8 4.4" />
            <path d="M14.8 14c0 3.1-1.2 5.1-2.1 6.2" />
            <path d="M6.2 14a5.8 5.8 0 0 1 11.6 0c0 1.3-.2 2.5-.5 3.6" />
            <path d="M4 11.5a8.5 8.5 0 0 1 16 0" />
            <path d="M7 5.2a11 11 0 0 1 10 0" />
            @break
